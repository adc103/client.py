"""DEEBOT GOAT A3000 LiDAR Capabilities."""
...
from deebot_client.commands.json.clean import CleanMower, CleanAreaV2, GetCleanInfo
    ...
    return StaticDeviceInfo(
        ...
        Capabilities(
            ...
            clean=CapabilityClean(
                action=CapabilityCleanAction(command=CleanMower, area=CleanAreaV2),
            ),
